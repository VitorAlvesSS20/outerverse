...
Sua mutação particular, a marca deixada pelo "Príncipe do Sangue", manifestava-se como fendas nas costelas e no pescoço, parecidas com brânquias. Elas não serviam para respirar. Serviam para chorar sangue, o tempo todo. Era preciso um effort mental absurdo para não rasgar a própria carne em busca de alívio.
...
Mas a paz na Abel Academy dura pouco.
...
Em um segundo, dezenas de cabeças giraram em direção à mesa. Pupilas se dilataram até os olhos ficarem completamente pretos. Mutações escondidas sob as roupas começaram a rasgar tecidos. Tentáculos se retesaram nas mangas. Ossos estalaram sob os coletes. A "civilidade" sumiu. Só sobrou a fome.
...
Vex agarrou a borda da mesa com tanta força que os nós dos seus dedos empalideceram. Ele lutou contra o próprio corpo, enquanto o refeitório da Abel Academy despencava no abismo, prestes a virar um matadouro.`,
      },
      {
        id: 2,
        title: 'CAPÍTULO II: A EUCARISTIA DO CAOS',
        content: `O silêncio que se seguiu ao estilhaçar da porcelana não foi uma ausência de som. Foi um vácuo faminto, uma pressão que sugava o oxigênio dos pulmões. Naquela fração de segundo, a civilidade da Abel Academy, aquela pátina fina de erudição e etiqueta, descascou como tinta velha sob o calor de uma fornalha.
...
O som que se seguiu não foi um grito, mas o toque de um sino de prata: uma nota única, pura e insuportavelmente alta que reverberou pelas paredes da Abel Academy.
...
— A Academia dá-lhes a forma. Mas hoje, vocês provaram que ainda são apenas argila úmida e sangrenta. Limpe-se. O Conselho quer um relatório sobre este "incidente". E não pense que sua tentativa de contenção o livrará da punição. Na Abel Academy, a falha de um é a falha da raça.
...
Vex permaneceu ali, entre os destroços de porcelana e os ecos de gritos silenciados, sentindo o gosto amargo do leite e do ferro em sua língua. Ele olhou para suas mãos; o sangue ocultista que ele conjurara agora era apenas uma mancha seca e sem brilho na madeira.`,
      ...
      {
        id: 3,
        title: 'CAPÍTULO III: A LITURGIA DAS CISTERNAS ALVAS',
        content: `O descenso para as entranhas da Abel Academy era uma jornada através de círculos concêntricos de um frio estéril. Vex era conduzido pelos Pacificadores — os autômatos de latão e couro cujas engrenagens rangiam num compasso rítmico, indiferentes à agonia que escoltavam. O ar, antes saturado pelo odor de ferro, tornara-se denso com uma névoa de cânfora e leite vaporizado. Eles haviam chegado às Cisternas de Marfim, o local onde a carne rebelde dos Hemorrágicos era forçada ao arrependimento através da hidroterapia alquímica.
...
— Você é um Ocultista. Possui um potencial além das bestas consumidas por seus instintos selvagens. Você busca impor ordem no caos... Isso não é ser argila. Isso é ser o escultor e a pedra ao mesmo tempo.
...
Vex permaneceu no banho de leite, sentindo sua pele agora tensa e artificialmente curada. Ele olhou para o próprio reflexo na superfície branca do líquido. Não via mais apenas um estudante trágico ou uma mutação interrompida. Via a promessa de algo antigo e faminto, uma força que nenhum volume de leite ou oração ao Príncipe poderia conter por muito mais tempo.`,
      ...
      {
        id: 4,
        title: 'CAPÍTULO IV: OS CÓDICES DE CARNE E A BIBLIOTECA DOS LAMENTOS',
...
Ele caminhava pelos corredores transversais da Abel Academy. Ali, a arquitetura gótica se fundia a protuberâncias orgânicas que lembravam veias petrificadas escalando as colunas de mármore negro. Seu destino não era o dormitório, nem o confessionário dos Pastores. Era o coração intelectual do Domo: a Biblioteca.
